...
//  My Tickets
//
//  Created by Jeff@Level3 on 3/27/15.
//
//

#ifndef My_Tickets_InvitationModel_h
#define My_Tickets_InvitationModel_h

static NSString * const MTParseInvitationClassName = @"Invitation";
